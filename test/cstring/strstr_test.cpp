...
TEST(LlvmLibcStrStrTest, NeedleNotInHaystack) {
  ...
  const char *needle = "a";
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), nullptr);
}

TEST(LlvmLibcStrStrTest, NeedleIsEmptyString) {
  const char *haystack = "12345";
  const char *needle = "";
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), haystack);
}
...
TEST(LlvmLibcStrStrTest, HaystackAndNeedleAreEmptyStrings) {
  const char *haystack = "";
  const char *needle = "";
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), "");
}

TEST(LlvmLibcStrStrTest, HaystackAndNeedleAreSingleCharacters) {
  const char *haystack = "a";
  // Same characer returns that character.
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, /*needle=*/"a"), "a");
  // Different character returns nullptr.
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, /*needle=*/"b"), nullptr);
}

TEST(LlvmLibcStrStrTest, NeedleEqualToHaystack) {
  const char *haystack = "12345";
  const char *needle = "12345";
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), "12345");
}

TEST(LlvmLibcStrStrTest, NeedleSmallerThanHaystack) {
  const char *haystack = "12345";
  const char *needle = "345";
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), "345");
}
...
TEST(LlvmLibcStrStrTest, NeedleInMiddle) {
  ...
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), "defghi");
}

TEST(LlvmLibcStrStrTest, NeedleDirectlyBeforeNullTerminator) {
  const char *haystack = "abcdefghi";
  const char *needle = "ghi";
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, needle), "ghi");
}
...
TEST(LlvmLibcStrStrTest, NeedlePastNullTerminator) {
  ...
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, /*needle=*/"3"), nullptr);
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, /*needle=*/"4"), nullptr);
}
...
TEST(LlvmLibcStrStrTest, MorphedNeedle) {
  ...
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, "time"), "time");
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, "lime"), nullptr);
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, "tome"), nullptr);
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, "tire"), nullptr);
  ASSERT_STREQ(__MACONDO_TEST_NAMESPACE::strstr(haystack, "timo"), nullptr);
}