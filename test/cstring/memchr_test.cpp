...
const char *call_memchr(const void *src, int c, size_t size) {
  return reinterpret_cast<const char *>(__MACONDO_TEST_NAMESPACE::memchr(src, c, size));
}
