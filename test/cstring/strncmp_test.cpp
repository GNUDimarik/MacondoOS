...
TEST(LlvmLibcStrNCmpTest, EmptyStringsShouldReturnZeroWithSufficientLength) {
  const char *s1 = "";
  const char *s2 = "";
  int result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 1);
  ASSERT_EQ(result, 0);

  // Verify operands reversed.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s2, s1, 1);
  ASSERT_EQ(result, 0);
}
...
TEST(LlvmLibcStrNCmpTest,
  ...
  const char *empty = "";
  const char *s2 = "abc";
  int result = __MACONDO_TEST_NAMESPACE::strncmp(empty, s2, 3);
  // This should be '\0' - 'a' = -97
  ASSERT_EQ(result, -97);

  // Similar case if empty string is second argument.
  const char *s3 = "123";
  result = __MACONDO_TEST_NAMESPACE::strncmp(s3, empty, 3);
...
TEST(LlvmLibcStrNCmpTest, EqualStringsShouldReturnZeroWithSufficientLength) {
  const char *s1 = "abc";
  const char *s2 = "abc";
  int result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 3);
  ASSERT_EQ(result, 0);

  // Verify operands reversed.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s2, s1, 3);
  ASSERT_EQ(result, 0);
}
...
TEST(LlvmLibcStrNCmpTest,
  ...
  int result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 8);
  // This should return 'B' - 'C' = -1.
  ASSERT_EQ(result, -1);

  // Verify operands reversed.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s2, s1, 8);
...
TEST(LlvmLibcStrNCmpTest,
  ...
  const char *s1 = "abcd";
  const char *s2 = "abCd";
  int result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 4);
  // 'c' - 'C' = 32.
  ASSERT_EQ(result, 32);

  // Verify operands reversed.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s2, s1, 4);
  // 'C' - 'c' = -32.
  ASSERT_EQ(result, -32);
}
...
TEST(LlvmLibcStrNCmpTest, StringArgumentSwapChangesSignWithSufficientLength) {
  const char *a = "a";
  const char *b = "b";
  int result = __MACONDO_TEST_NAMESPACE::strncmp(b, a, 1);
  // 'b' - 'a' = 1.
  ASSERT_EQ(result, 1);

  result = __MACONDO_TEST_NAMESPACE::strncmp(a, b, 1);
  // 'a' - 'b' = -1.
  ASSERT_EQ(result, -1);
}
...
TEST(LlvmLibcStrNCmpTest, NonEqualStringsEqualWithLengthZero) {
  const char *s1 = "abc";
  const char *s2 = "def";
  int result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 0);
  ASSERT_EQ(result, 0);

  // Verify operands reversed.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s2, s1, 0);
  ASSERT_EQ(result, 0);
}
...
TEST(LlvmLibcStrNCmpTest, NonEqualStringsEqualWithShorterLength) {
  ...
  // This should return 'B' - 'C' = -1.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 4);
  ASSERT_EQ(result, -1);
...
TEST(LlvmLibcStrNCmpTest, StringComparisonEndsOnNullByteEvenWithLongerLength) {
  ...
  int result = __MACONDO_TEST_NAMESPACE::strncmp(s1, s2, 7);
  ASSERT_EQ(result, 0);

  // Verify operands reversed.
  result = __MACONDO_TEST_NAMESPACE::strncmp(s2, s1, 7);
  ASSERT_EQ(result, 0);
}