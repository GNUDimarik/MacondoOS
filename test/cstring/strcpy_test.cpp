...
TEST(LlvmLibcStrCpyTest, EmptySrc) {
  ...
  char *result = __MACONDO_TEST_NAMESPACE::strcpy(dest, empty);
...
TEST(LlvmLibcStrCpyTest, EmptyDest) {
  ...
  char *result = __MACONDO_TEST_NAMESPACE::strcpy(dest, abc);
  ASSERT_EQ(dest, result);
  ASSERT_STREQ(dest, result);
...
TEST(LlvmLibcStrCpyTest, OffsetDest) {
  ...
  char *result = __MACONDO_TEST_NAMESPACE::strcpy(dest + 3, abc);
