...
TEST(LlvmLibcstrndupTest, EmptyString) {
  ...
  char *result = __STD_NAMESPACE::strndup(empty, 1);
...
TEST(LlvmLibcstrndupTest, AnyString) {
  ...
  char *result = __STD_NAMESPACE::strndup(abc, 3);
  ...
  result = __STD_NAMESPACE::strndup(abc, 1);
  ...
  result = __STD_NAMESPACE::strndup(abc, 10);
...
TEST(LlvmLibcstrndupTest, NullPtr) {
  char *result = __STD_NAMESPACE::strndup(nullptr, 0);
