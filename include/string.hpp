 ...
 * memory area.
 */
void *memcpy(void *dest, const void *src, size_t length) __nonnull((1, 2));
 ...
 */
void *memmove(void *dest, const void *src, size_t length) __nonnull((1, 2));
/**
 ...
 */
void *memchr(const void *mem, int needle, size_t count) __nonnull((1));
 ...
 */
int memcmp(const void *first, const void *second, size_t length) __nonnull((1, 2));
 ...
 */
void *memset(void *dest, int value, size_t length) __nonnull((1));
 ...
 * is undefined.
 */
char *strcat(char *dest, const char *src) __nonnull((1));
 ...
 *                    error.
 */
char *strncat(char *dest, const char *src, size_t length) __nonnull((1, 2));
 ...
 *                  not found
 */
char *strchr(const char *str, int needle) __nonnull((1));
 ...
 *                   occur in the string.
 */
char *strrchr(const char *str, int needle) __nonnull((1));
 ...
 * @return -1 if first < second, 1 otherwise and 0 if they are equal
 */
int strcmp(const char *first, const char *second) __nonnull((1, 2));
 ...
 * undefined
 */
char *strcpy(char *dest, const char *src) __nonnull((1));
 ...
 * undefined
 */
char *strncpy(char *dest, const char *src, size_t n) __nonnull((1, 2));
 ...
 *                  an error
 */
size_t strspn(const char *str, const char *accept) __nonnull((1, 2));
 ...
 */
size_t strlen(const char *str) __nonnull((1));
 ...
 *                  error.
 */
size_t strcspn(const char *str, const char *reject) __nonnull((1, 2));
 ...
 *                   occurs in accept
 */
char *strpbrk(const char *str, const char *accept) __nonnull((1, 2));
 ...
 * haystack.
 */
char *strstr(const char *haystack, const char *needle) __nonnull((1, 2));

/**
 * @brief  strtok_r - a sequence of calls to strtok_r() breaks the string pointed to
 ...
 */
char *strtok_r(char *str, const char *delim, char **lasts) __nonnull((2));

/**
 * @brief strdup - duplicates a string pointed by str via malloc() function
 * @param str    - string to duplication
 ...
 *
 * errors: ENOMEM Storage space available is insufficient.
 */
__END_DECLS
__STD_END_NAMESPACE
/** @} */